...
public class DiceGame()
{
    public static void Main()
    {
        ...
        // Input validation to commence the Cee-lo game.
        Console.WriteLine("\nWould you like to play Cee-Lo? Yes/No)");
        string Startresponse = Console.ReadLine().ToLower();

        while (Startresponse == "No")
        {
            Console.WriteLine("Game pending, if you wish to play please enter: Yes.");
        }


        bool playAgain = true;

        // Loop enables players to play as long as they want.
        while (playAgain)
        {
            ...
            // creates player two's dice and rolls them, and stores the results in an array
            ...
            if (player2AutoLose == false && player2AutoWin == false)
            {
                ...
                {
                    Console.WriteLine("player 2 scored a point!\n");
                    secondPlayPoints++;
                }
            ...
            // Checks and compares roll results, Then displays the matches verdict to the User(s).
            if (player1AutoWin == true && player2AutoLose == true)
            {
                Console.WriteLine("This match is a tie game");
            }
            else if (player1AutoWin == true && player2AutoLose != true)
            {
            ...
            else if (player1AutoLose == true && player2AutoLose == true)
            {
                Console.WriteLine("This match is a tie game");
            }
            else if (player1AutoLose == true && player2AutoLose != true)
            ...
            {
                if (firstPlayPoints == secondPlayPoints)
                {
                    Console.WriteLine("This match is a tie!!!!");
                }
                else if (firstPlayPoints > secondPlayPoints)
                {
                    Console.WriteLine("Player 1 Wins!!!");
                }
                else if (firstPlayPoints < secondPlayPoints)
